...
> = {
  "oddenova-dark": {
    background: "var(--oddenova-editor-dark-background)",
    foreground: "var(--oddenova-editor-dark-foreground)",
    caret: "var(--oddenova-editor-dark-caret)",
    selection: "var(--oddenova-editor-dark-selection)",
    lineHighlight: "var(--oddenova-editor-dark-line)",
    gutterBackground: "transparent",
    gutterForeground: "var(--oddenova-editor-dark-gutter-foreground)",
    gutterBorder: "var(--oddenova-editor-dark-gutter-border)",
  },
  "oddenova-light": {
    background: "var(--oddenova-editor-light-background)",
    foreground: "var(--oddenova-editor-light-foreground)",
    caret: "var(--oddenova-editor-light-caret)",
    selection: "var(--oddenova-editor-light-selection)",
    lineHighlight: "var(--oddenova-editor-light-line)",
    gutterBackground: "transparent",
    gutterForeground: "var(--oddenova-editor-light-gutter-foreground)",
    gutterBorder: "var(--oddenova-editor-light-gutter-border)",
  },
  dracula: {
    background: "#282a36",
    foreground: "#f8f8f2",
