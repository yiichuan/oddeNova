 ...
 * @version v2
 * @date 2026-05-22
 * @description 新增"强制信号调制"和"风格签名技巧"两条音乐原则 + cheatsheet 扩展 + improvise 质量门
 */
// ============================================================================
...
export const AGENT_SYSTEM_PROMPT = [
  ...
  '4. **Improvise quality gate**: After receiving `improvise` output, check it for signal modulation. If the snippet has NO `.range(` call AND the composition currently has fewer than 2 modulated layers, append `.lpf(sine.range(400,800).slow(8)).lpq(5)` or `.gain(perlin.range(.5,.9))` before plugging it in.',
