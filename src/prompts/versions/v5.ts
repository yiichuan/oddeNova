 ...
 * @version v5
 * @date 2026-05-23
 * @description 移除 REFERENCE_COMPOSITION 代码示例；将 getStyleGuide 返回内容改为
 *              纯文字风格描述（保留 BPM/Bank/gain 等技术规格，去掉 Strudel 代码块）。
 */
// ============================================================================
