 ...
 * @version v4
 * @date 2026-05-22
 * @description 系统提示词精简：Style matching 改为调用 getStyleGuide 工具获取各风格规范；移除 Musicality principles #8（Style signatures 已迁入各风格文件）
 */
// ============================================================================
...
export const AGENT_SYSTEM_PROMPT = [
  ...
  '- Match the user description to ONE style by keyword (e.g. "学习/lo-fi/夜晚" → `lofi`, "快节奏/drum and bass" → `dnb`, "808/切分/drill" → `trap`, "爵士/swing" → `jazz`). Once matched, call `getStyleGuide(styleId)` BEFORE writing any layer code — the guide contains BPM range, sample bank, per-role code examples, and signature techniques.',
